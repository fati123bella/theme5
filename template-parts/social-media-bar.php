...
// Get colors
$bg_color   = get_theme_mod( 'cozyrecipes_social_bar_bg_color', '#ffffff' );
...
<div class="social-media-bar" <?php echo wp_kses_post( $style ); ?>>
    <div class="social-bar-container">
        <?php if ( $facebook_url ) : ?>
            <a href="<?php echo esc_url( $facebook_url ); ?>" class="social-link facebook" title="<?php esc_attr_e( 'Facebook', 'cozyrecipes' ); ?>" target="_blank" rel="noopener noreferrer" style="color: <?php echo esc_attr( $icon_color ); ?>;">
        ...
        <?php if ( $twitter_url ) : ?>
            <a href="<?php echo esc_url( $twitter_url ); ?>" class="social-link twitter" title="<?php esc_attr_e( 'Twitter', 'cozyrecipes' ); ?>" target="_blank" rel="noopener noreferrer" style="color: <?php echo esc_attr( $icon_color ); ?>;">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
        ...
        <?php if ( $instagram_url ) : ?>
            <a href="<?php echo esc_url( $instagram_url ); ?>" class="social-link instagram" title="<?php esc_attr_e( 'Instagram', 'cozyrecipes' ); ?>" target="_blank" rel="noopener noreferrer" style="color: <?php echo esc_attr( $icon_color ); ?>;">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
        ...
        <?php if ( $pinterest_url ) : ?>
            <a href="<?php echo esc_url( $pinterest_url ); ?>" class="social-link pinterest" title="<?php esc_attr_e( 'Pinterest', 'cozyrecipes' ); ?>" target="_blank" rel="noopener noreferrer" style="color: <?php echo esc_attr( $icon_color ); ?>;">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
        ...
        <?php if ( $youtube_url ) : ?>
            <a href="<?php echo esc_url( $youtube_url ); ?>" class="social-link youtube" title="<?php esc_attr_e( 'YouTube', 'cozyrecipes' ); ?>" target="_blank" rel="noopener noreferrer" style="color: <?php echo esc_attr( $icon_color ); ?>;">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
        ...
        <?php if ( $tiktok_url ) : ?>
            <a href="<?php echo esc_url( $tiktok_url ); ?>" class="social-link tiktok" title="<?php esc_attr_e( 'TikTok', 'cozyrecipes' ); ?>" target="_blank" rel="noopener noreferrer" style="color: <?php echo esc_attr( $icon_color ); ?>;">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
