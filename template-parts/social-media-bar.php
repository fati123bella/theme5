            ...
            <div class="social-icons-center" <?php echo wp_kses_post( $icon_style ); ?>>
                <?php if ( $facebook_url ) : ?>
                    <a href="<?php echo esc_url( $facebook_url ); ?>" class="social-icon-link facebook" title="Facebook" target="_blank" rel="noopener noreferrer">
                        <svg width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" style="width:16px;height:16px;display:block;">
                ...
                <?php if ( $instagram_url ) : ?>
                    <a href="<?php echo esc_url( $instagram_url ); ?>" class="social-icon-link instagram" title="Instagram" target="_blank" rel="noopener noreferrer">
                        <svg width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" style="width:16px;height:16px;display:block;">
                            <rect x="2.16" y="2.16" width="19.68" height="19.68" rx="4.57" ry="4.57" fill="none" stroke="currentColor" stroke-width="1.08"/>
                            <circle cx="12" cy="12" r="5.4" fill="none" stroke="currentColor" stroke-width="1.08"/>
