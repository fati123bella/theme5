...
<?php
// Popular Categories Section - Moved right after hero search
...
if ( $show_categories ) :
    ...
    if ( ! empty( $categories ) ) :
        ?>
        <section class="content-section popular-categories categories-slider-section">
            <div class="<?php echo esc_attr( cozyrecipes_get_container_class() ); ?>">
                ...
                <div class="categories-slider-wrapper">
                    <button class="category-slider-arrow category-slider-prev" aria-label="Previous categories">
                    ...
                    <div class="categories-slider">
                        <div class="categories-slider-track">
                            <?php
                            // Category icons mapping with SVG-style emojis
                                ...
                                <div class="category-slide">
                                    <a href="<?php echo esc_url( get_category_link( $category->term_id ) ); ?>" class="category-card">
                                        <div class="category-icon-wrapper">
                                            <span class="category-icon" role="img" aria-label="<?php echo esc_attr( $category->name ); ?>"><?php echo $icon; ?></span>
                                        </div>
                            ...
                            endforeach;
                            ?>
                        </div><!-- .categories-slider-track -->
                    </div><!-- .categories-slider -->

                    <button class="category-slider-arrow category-slider-next" aria-label="Next categories">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
